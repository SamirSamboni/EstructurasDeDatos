...
public class PanelDiscos extends JPanel implements ActionListener
{
    ...
    /**
     * Comando para el bot�n para agregar un disco
     */
    ...
    /**
     * Es el campo con el g�nero del disco
     */
    ...
    /**
     * Es el bot�n para mostrar el di�logo para agregar un nuevo disco
     */
    private JButton botonAgregarDisco;

    /**
     * Es el campo que muestra la im�gen del disco
     */
    ...
    /**
     * Construye el panel para la informaci�n de un disco de la discotienda
    ...
    /**
     * Actualiza la informaci�n en el panel con la lista de discos
